...
{/* 
  ...
  <button className="contact-btn" onClick={handleContact}>
    Contact Me
                    ...
                    <div className="stat-grid">
                      ...
                      <div className="stat-item">
                        ...
                        <span className="value">
                          {dataUser.avgResponseTime} hours
                        </span>
                      </div>
                      <div className="stat-item">
                        <span className="label">Last delivery</span>
                        <span className="value">
                          {dataUser.lastDelivery}{" "}
                          {dataUser.lastDelivery === 1 ? "day" : "days"}
                        </span>
                      </div>
                      <div className="stat-item">
            ...
            <Reviews gigId={id} isMyOwnGig={isSellerViewingOwnGig} />
          </div>
              ...
              {!isSellerViewingOwnGig && (
                <>
                  ...
                  <div className="guarantee">
                    <span>TalentHub Protection:</span> Payment is released to
                    the freelancer once you're satisfied with the work.
                  </div>
                </>
              )}
            </div>
